...
Record the authoritative assignment path and a traceable constraint table here.
...
Undecided. Identify at least three before course content.

## Course checkpoints

Undecided. Derive observable capabilities from the breaking points.

## Capstone contract

Working grader that prints real precision and recall. Define acceptance details during backward design.

## Agile hierarchy and epic boundaries

Undecided. Do not copy illustrative lesson ideas into this section. Derive and obtain approval later.
