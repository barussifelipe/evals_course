...
Use `gpt-5.6-sol` with `high` reasoning. Read `../../references/methodology.md`, `../../references/output-layout.md`, `../../rubrics/behavior-penalties.md`, and `../../rubrics/orchestrator.md`.
