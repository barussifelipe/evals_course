...
Use `gpt-5.6-sol` with `low` reasoning. Read `../../references/methodology.md`, `../../references/output-layout.md`, `../../rubrics/behavior-penalties.md`, and `../../rubrics/builder.md`.
