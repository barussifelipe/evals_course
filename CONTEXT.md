...
`EP-03` — **Measure the grader**. Planning, research, and generation are not yet authorized in this run. It must consume the approved EP-01 and EP-02 artifacts and complete the capstone without changing their ID or label semantics.
...
- EP-03 must join EP-01 cases and EP-02 predictions by `case_id`, verify copied labels, and compute metrics without relying on row order.
